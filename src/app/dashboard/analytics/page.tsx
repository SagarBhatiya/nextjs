              ...
              <div className="text-right">
                <p
                  className={`text-sm mt-2 ${
                    metric.isPositive ? "text-green-600" : "text-res-600"
                  }`}
                >
                  {metric.change}
                </p>
            ...
            <ul className="space-y-4">
              <li className="flex items-center justify-between bg-white rounded-lg shadow-md p-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">New user signed up on 2025-06-2</p>
                </div>
                <div>
               ...
               <li className="flex items-center justify-between bg-white rounded-lg shadow-md p-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Sales grew by 12% on 2025-06-12</p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">+Rs 15,00,000</p>
                </div>
              </li>
               <li className="flex items-center justify-between bg-white rounded-lg shadow-md p-4">
                <div>
                  <h3 className="text-lg font-semibold text-gray-700">Website Traffic Surge</h3>
                  <p className="text-sm text-gray-600">Traffic increased by 8% on 2025-06-15</p>
                </div>
                <div>
