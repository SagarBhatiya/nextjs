          ...
          <div className="w-1/4 bg-white rounded-lg p-6 space-y-6">
            ...
            <ul className="space-y-4">
              <li>
                ...
                hover:text-indigo-600 transition-colors py-2 px-4 rounded-md
                hover:bg-indigo-50"
              ...
              <li>
                <Link
                  className="flex items-center text-lg text-gray-800 
                hover:text-yellow-600 transition-colors py-2 px-4 rounded-md
                hover:bg-yellow-50"
              ...
              <li>
                <Link
                  className="flex items-center text-lg text-gray-800 
                hover:text-green-600 transition-colors py-2 px-4 rounded-md
                hover:bg-green-50"
